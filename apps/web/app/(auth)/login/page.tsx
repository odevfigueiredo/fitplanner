  ...
  return (
    <main className="grid min-h-screen place-items-center bg-[var(--background)] px-4">
      <section className="w-full max-w-md rounded-lg border border-[var(--line)] bg-[#0c100f] p-6">
        ...
        <p className="mt-2 text-sm leading-6 text-[var(--muted)]">Acesse treinos, histórico e progresso físico.</p>
        <div className="mt-6">
          <AuthForm mode="login" />
        </div>
        <Link href="/register" className="mt-5 block text-center text-sm font-bold text-[var(--neon)]">
          Criar conta
        </Link>
      </section>
    </main>
